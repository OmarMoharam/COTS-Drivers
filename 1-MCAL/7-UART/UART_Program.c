...
void UART_voidInit(u16 Copy_u16BaudRate)
{
    ...
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (0<<UART_u8_UCSRC_UMSEL_BIT);
    ...
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_UMSEL_BIT);
    ...
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (0<<UART_u8_UCSRC_UCSZ1_BIT) | (0<<UART_u8_UCSRC_UCSZ0_BIT);
   
    #elif CHARCTER_SIZE == SIX_BITS
    CLR_BIT(UART_u8_UCSRB_REGISTER, UART_u8_UCSRB_UCSZ2_BIT);
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (0<<UART_u8_UCSRC_UCSZ1_BIT) | (1<<UART_u8_UCSRC_UCSZ0_BIT);
   
    #elif CHARCTER_SIZE == SEVEN_BITS
    CLR_BIT(UART_u8_UCSRB_REGISTER, UART_u8_UCSRB_UCSZ2_BIT);
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_UCSZ1_BIT) | (0<<UART_u8_UCSRC_UCSZ0_BIT);

    #elif CHARCTER_SIZE == EIGHT_BITS
    CLR_BIT(UART_u8_UCSRB_REGISTER, UART_u8_UCSRB_UCSZ2_BIT);
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_UCSZ1_BIT) | (1<<UART_u8_UCSRC_UCSZ0_BIT);
    ...
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_UPM1_BIT) | (0<<UART_u8_UCSRC_UPM0_BIT);

    #elif PARITY_BIT == ENABLE_ODD
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_UPM1_BIT) | (1<<UART_u8_UCSRC_UPM0_BIT);

    #elif PARITY_BIT == DISABLE
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (0<<UART_u8_UCSRC_UPM1_BIT) | (0<<UART_u8_UCSRC_UPM0_BIT);
    #endif
    

    /******************* Choose Stop Bit *******************/
    #if STOP_BIT == ONE_BIT
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (0<<UART_u8_UCSRC_USBS_BIT);

    #elif STOP_BIT == TWO_BITS
    UART_u8_UCSRC_REGISTER |= (1<<UART_u8_UCSRC_URSEL_BIT) | (1<<UART_u8_UCSRC_USBS_BIT);
    #endif
